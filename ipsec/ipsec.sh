...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/IlhamStoree/perizinan/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $IZIN ]; then
...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/IlhamStoree/scriptvps/main/ipsec"
